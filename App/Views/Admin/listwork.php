                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card-box">
                            ...
                            <h4 class="header-title m-t-0 m-b-30">شما در اینجا تمام  نمونه ها را مشاهده می کنید</h4>
                                    ...
                                    foreach ($information as $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td><input style="text-align: left;font-size: 15px; width: 240px"
                                                       type="text" class="form-control" value="http://127.0.0.10/works/<?php echo $value['url']?>">
                                            </td>
                                            <td style="font-size: 17px"><?php if($cat->selectCatsingle($value['cat_id'])['id']==0){
                                                echo 'ندارد';
                                                }else{
                                                echo $cat->selectCatsingle($value['cat_id'])['title'];
                                                } ?></td>
                                            <td>
                                                <a class="btn btn-default waves-effect w-md waves-light m-b-5"><?php echo $value['star']?></a>
                                            </td>
                                            <td>
                                                <a href="http://127.0.0.10/dashbord/workedait/<?php echo $value['id']?>" class="btn btn-info waves-effect w-md waves-light m-b-5">ویرایش</a>
                                            </td>

                                            <td>
                                                <a href="http://127.0.0.10/dashbord/listwork?del=<?php echo $value['id']?>" class="btn btn-warning waves-effect w-md waves-light m-b-5">حذف</a>
                                            </td>
                                        </tr>
                                        <?php
                                    }}
