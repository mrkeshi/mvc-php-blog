...
<div class="card-box">
    ...
    <form class="form-horizontal" role="form" method="post">
        <div class="form-group">
            <label class="col-md-2 control-label">سرتیتر</label>
            <div class="col-md-10">
                <input value="<?php echo $value['titr1']?>" name="from[titr1]" type="text" class="form-control" placeholder="لطفا تیتر خود را وارد نمائید">
            </div>
        </div>
        <div class="form-group">
            <label class="col-md-2 control-label">متن</label>
            <div class="col-md-10">
                <textarea name="from[text]" type="text" class="form-control" placeholder="لطفا متن خود را وارد نمائید"><?php echo $value['text']?></textarea>
            </div>
        </div>
        <div class="form-group">
            <label class="col-md-2 control-label">اسم دکمه</label>
            <div class="col-md-10">
                <input value="<?php echo $value['btnname']?>" name="from[btnname]" type="text" class="form-control" placeholder="لطفا لینک دکمه ی خود را وارد نمائید">
            </div>
        </div>
        <div class="form-group">
            <label class="col-md-2 control-label"> لینک دکمه</label>
            <div class="col-md-10">
                <input style="text-align: left" name="from[url]" value="<?php echo $value['url']?>" type="text" class="form-control" placeholder="http://127.0.0.10">
            </div>
        </div>
            <div class="form-group">
                <button type="submit" name="btn"  class="btn btn-success waves-effect w-md waves-light m-b-5" style="font-size:18px;margin-right: 130px"> ذخیره </button>
            </div>
