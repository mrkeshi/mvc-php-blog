...
<div class="card-box">
    ...
    <form class="form-horizontal" role="form" method="post">
        <div class="form-group">
            ...
            <div class="col-md-10">
                <input value="<?php echo $information['title']?>" name="from[title]" type="text" class="form-control" placeholder="لطفا نام دسته بندی را وارد نمائید">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-md-10">
                <div class="input-group">
                    <input value="<?php echo $information['url']?>" style="text-align: left" id="example-input2-group1" name="from[url]" class="form-control" placeholder="آدرس">
                    <span class="input-group-addon " style="font-size: 18px;">http://site.ir/w</span>
                </div>
            </div>
        </div>
            <div class="form-group">
                <button type="submit" name="btn"  class="btn btn-success waves-effect w-md waves-light m-b-5" style="font-size:18px;margin-right: 130px">ویرایش دسته بندی</button>
            </div>
