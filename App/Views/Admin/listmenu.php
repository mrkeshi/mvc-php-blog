                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card-box">
                            ...
                            <h4 class="header-title m-t-0 m-b-30">شما در اینجا تمام  منو ها را مشاهده می کنید</h4>
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table m-0">
                                    ...
                                    <tbody>
                              <?php
                              if($information->showMenu()) {
                                    foreach ($information->showMenu() as $value){

                                  ?>
                                  <tr>
                                      <th scope="row"><?php echo $value['title']?></th>
                                      <td><input style="text-align: left;font-size: 18px; width: 240px" type="text"
                                                 class="form-control" value="<?php echo '127.0.0.10/'.$value['url']?>"></td>
                                      <td><?php
                                          if($information->showParent($value['child_id'])){
                                              echo $information->showParent($value['child_id'])['title'];
                                          }else{
                                              echo 'ندارد';
                                          }
                                          ?></td>
                                      <td>
                                        <?php
                                              if($value['status']=='0'){
                                                  echo '<span class="btn btn-danger waves-effect w-md waves-light m-b-5">غیر فعال</span>';
                                              }else{
                                                  echo '<span class="btn btn-success waves-effect w-md waves-light m-b-5"> فعال</span>';
                                              }
                                              ?>
                                      </td>
                                      <td><?php echo $value['sort']?></td>
                                      <td><a href="http://127.0.0.10/dashbord/listmenu/edait/<?php echo $value['id']?>" class="btn btn-info waves-effect w-md waves-light m-b-5">ویرایش</a>
                                      </td>
                                      <td><a href="http://127.0.0.10/dashbord/listmenu?del=<?php echo $value['id'] ?>" class="btn btn-warning waves-effect w-md waves-light m-b-5">حذف</a>
                                      </td>
                                  </tr>
                                  <?php
                              }}
