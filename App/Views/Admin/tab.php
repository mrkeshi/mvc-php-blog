...
<h2>قسمت اول</h2>
    <form class="form-horizontal" role="form" method="post">
        <div class="form-group">
            ...
            <div class="col-md-10">
                <input value="<?php echo $value['title1']?>" name="from[title1]" type="text" class="form-control" placeholder="لطفا نام  تب  را وارد نمائید">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-md-10">
                <div class="input-group">
                    <select class="form-control" name="from[type]" id="">
                        <option value="comment_tbl">نمایش آخرین نظرات</option>
                        <option value="post_tbl" <?php if($value['type']=='post_tbl'){
                                        echo ' selected';
                        } ?>>نمایش آخرین مطالب</option>
                        <option <?php if($value['type']=='work_tbl'){
                            echo ' selected';
                        } ?> value="work_tbl">نمایش آخرین نمونه کار ها</option>
                    </select>
                </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-10">
                <div class="input-group">
                    <select class="form-control" name="from[count]" id="">
                        <option value="1">1</option>
                        <option value="5" <?php if ($value['count']=='5'){
                            echo ' selected';
                        } ?>>5</option>
                        <option value="10" <?php if ($value['count']=='10'){
                            echo ' selected';
                        } ?> >10</option>
                    </select>
                </div>
        ...
        <div class="card-box">
            <h2>قسمت دوم</h2>
                <div class="form-group">
                    <label class="col-md-2 control-label">عنوان </label>
                    <div class="col-md-10">
                        <input value="<?php echo $value['title2'] ?>" name="from[title2]" type="text" class="form-control" placeholder="لطفا نام تب را وارد نمائید">
                    </div>
                </div><br><br>
                <div class="form-group">
                    <label class="col-md-2 control-label" for="example-email">نوع</label>
                    <div class="col-md-10">
                        <div class="input-group">
                            <select class="form-control" name="from[type2]" id="">
                                <option value="comment_tbl">نمایش آخرین نظرات</option>
                                <option value="post_tbl" <?php if($value['type2']=='post_tbl'){
                                                            echo ' selected';
                                } ?>>نمایش آخرین مطالب</option>
                                <option <?php if($value['type2']=='page_tbl'){
                                    echo ' selected';
                                } ?> value="page_tbl">نمایش آخرین صفحات</option>
                                <option <?php if($value['type2']=='work_tbl'){
                                    echo ' selected';
                                } ?> value="work_tbl">نمایش آخرین نمونه کارها</option>
                            </select>
                        </div>
                    </div>
                </div>
            <div class="form-group"><br><br>
                ...
                <div class="col-md-10">
                    <div class="input-group">
                        <select class="form-control" name="from[count2]" id="">
                            <option value="1">1</option>
                            <option value="5" <?php if ($value['count2']=='5'){
                                echo ' selected';
                            } ?>>5</option>
                            <option value="10" <?php if($value['count2']=='10'){
                                echo ' selected';
                            } ?>>10</option>
                        </select>
                    </div>
