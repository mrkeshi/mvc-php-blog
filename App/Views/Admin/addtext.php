                        ...
                        <div class="card-box">
                            ...
                            <form class="form-horizontal" method="post">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input value="<?php echo $value['title']?>" type="text" name="from[title]" class="form-control" placeholder="لطفا نام ویجت متنی  خود را وارد نمائید">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-2 control-label">متن </label>
                                    <div class="col-md-10">
                                        <textarea id="elm1" name="from[text]"><?php echo $value['text']?></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <button type="submit" style="margin-top: 20px;margin: 20px 410px 0px 0px;font-size:23px "  name="btn" class="btn btn-success waves-effect w-md waves-light m-b-5" style="!important;margin-right: 130px">   ویرایش ویجت</button>
                                </div>
                            </form>
                        </div>
                    </div><!-- end col -->
