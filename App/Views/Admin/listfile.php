                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card-box">
                            ...
                            <h4 class="header-title m-t-0 m-b-30">شما در اینجا تمام  فایل های آپلود شده ها را مشاهده می کنید</h4>
                                ...
                                <table class="table m-0">
                                    ...
                                    foreach ($information->showFiles() as $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="http://127.0.0.10/dashbord/up/files?del=<?php echo $value['id']?>" class="btn btn-warning waves-effect w-md waves-light m-b-5">حذف</a>
                                            </td>
                                        </tr>
                                        <?php
                                    }}}
