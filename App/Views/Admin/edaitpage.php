                        ...
                        <div class="card-box">
                            ...
                            <form class="form-horizontal" method="post">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input value="<?php echo $information['title']?>" type="text" name="from[name]" class="form-control" placeholder="لطفا نام صفحه خود را وارد نمائید">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <div class="input-group">
                                            <input value="<?php echo $information['url']?>" name="from[url]" style="text-align: left"  id="example-input2-group1"  class="form-control" placeholder="آدرس">
                                ...
                                <div class="form-group">
                                    <button name="btn" type="submit" style="margin-top: 20px;margin: 20px 410px 0px 0px;font-size:23px "  class="btn btn-success waves-effect w-md waves-light m-b-5" style="!important;margin-right: 130px">ویرایش صفحه  </button>
                                </div>
                            </form>
                        </div>
                    </div><!-- end col -->
