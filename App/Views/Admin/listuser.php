        ...
        <div class="navbar navbar-default" role="navigation">
            <div class="container">
                ...
                <ul class="nav navbar-nav navbar-left">
                    ...
                    <li>
                        <h4 class="page-title">افزودن دسته بندی</h4>
                    </li>
                </ul>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card-box">
                            ...
                            <h4 class="header-title m-t-0 m-b-30">شما در اینجا تمام کاربران را مشاهده می کنید</h4>

                            <p class="text-muted font-13 m-b-25">
                                شما در این صفحه امکان حذف و ویرایش کاربران را دارا هستید.
                            </p>
                            <style>
                                th,tr{
                            ...
                            <div class="table-responsive">
                                <table class="table m-0">
                                    ...
                                    <tbody>
                                    <tr>
                                        <th scope="row">sepahan82</th>
                                        <td>علیرضا کشاورز </td>
                                        <td>paresseop28@gmail.com </td>
                                        <td><strong style="color: #8a1f11">فوق پیشرفته</strong></td>
                                        <td><span  class="btn btn-success waves-effect w-md waves-light m-b-5">مشاهده</span> </td>
                                        <td><span  class="btn btn-info waves-effect w-md waves-light m-b-5">ویرایش</span></td>
                                        <td><span class="btn btn-danger waves-effect w-md waves-light m-b-5">حذف</span></td>
                                    </tr>
