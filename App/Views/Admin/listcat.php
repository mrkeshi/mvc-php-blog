                                    ...
                                    foreach ($information as $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td><input style="text-align: left;font-size: 18px; width: 240px"
                                                       ...
                                                       value="https:site.ir/c<?php echo $value['url'] ?>"></td>
                                            <td>
                                                <span class="btn btn-success waves-effect w-md waves-light m-b-5"><?php echo $conut->countCat($value['id'])?></span>
                                            </td>
                                            <td>
                                                <a href="http://127.0.0.10/dashbord/listcat/edait/<?php echo $value['id']?>" class="btn btn-info waves-effect w-md waves-light m-b-5">ویرایش</a>
                                            </td>
                                            <td>
                                                <a href="http://127.0.0.10/dashbord/listcat?del=<?php echo $value['id']?>" class="btn btn-danger waves-effect w-md waves-light m-b-5">حذف</a>
                                            </td>
                                        </tr>
                                        <?php
                                    }}
