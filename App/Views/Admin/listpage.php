                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card-box">
                            ...
                            <h4 class="header-title m-t-0 m-b-30">شما در اینجا تمام  صفحه ها را مشاهده می کنید</h4>
                                ...
                                <table class="table m-0">
                                    ...
                                    foreach ($information as $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td><input style="text-align: left;font-size: 18px; width: 240px"
                                                       type="text" class="form-control" value="https:127.0.0.10/<?php echo $value['url']?>">
                                            </td>
                                            <td>
                                                <a href="http://127.0.0.10/dashbord/listpage/show/<?php echo $value['id']?>" class="btn btn-default waves-effect w-md waves-light m-b-5">مشاهده</a>

                                            </td>
                                            <td>
                                                <a href="http://127.0.0.10/dashbord/listpage/edait/<?php echo $value['id']?>" class="btn btn-info waves-effect w-md waves-light m-b-5">ویرایش</a>
                                            </td>

                                            <td>
                                                <a href="http://127.0.0.10/dashbord/listpage?del=<?php echo $value['id']?>" class="btn btn-warning waves-effect w-md waves-light m-b-5">حذف</a>
                                            </td>
                                        </tr>
                                        <?php
                                    }}
