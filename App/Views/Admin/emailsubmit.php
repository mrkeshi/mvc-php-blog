                                        ...
                                        <div class="nano-content">
                                            ...
                                            <menu class="menu-segment">
                                                <ul class="list-unstyled">
                                                    <li class=""><a href="/<?php echo \Core\Config::ADMINPAGE.'/emailreceive'?>"">اینباکس
                                                            <span data-number=<?php echo $count ?> id="con">(<?php echo $count ?>)</span></a>
                                                    </li>
                                                    <li class="active"><a href="/<?php echo \Core\Config::ADMINPAGE.'/emailsubmit'?>">ارسالی</a></li>
                                                    </li>
                                                </ul>
                                            </menu>
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div id="message" class="f<?php echo $item['id'] ?>">
                                        <div class="header">
                                            ...
                                            <p>ازجانب <a href="/admin/#">شما</a>  به <a href="/admin/#"></a><?php echo $item['email']?>
                                                شروع از <a
                                        ...
                                        <div  id="message-nano-wrapper" class="nano">
                                            <div class="nano-content">
                                                <ul class="message-container list-unstyled">
                                                    <li class="sent">
                                                        <div class="details">
                                                            <div class="left">  <?php echo $item['email']?>
                                                                <div class="arrow"></div>
                                                             شما
                                                            </div>
