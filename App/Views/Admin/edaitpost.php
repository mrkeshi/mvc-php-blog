                        ...
                        <div class="card-box">
                            ...
                            <form class="form-horizontal" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input value="<?php echo $information['title']?>
" type="text" name="form[title]" class="form-control"
                                               placeholder="لطفا نام پست خود را وارد نمائید">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <div class="input-group">
                                            <input value="<?php echo $information['url'] ?>
" name="form[url]" style="text-align: left" id="example-input2-group1" class="form-control" placeholder="url post">
                                            <span class="input-group-addon " style="font-size: 18px;">http://site.ir/post</span>
                                        </div>
                                    </div>
                                </div>

                                <textarea id="elm1" name="form[text]">
                                    <?php echo $information['content'] ?>
                                </textarea>

                                <div class="form-group">
                                    <button type="submit"
                                            style="margin-top: 20px;margin: 20px 410px 0px 0px;font-size:23px "
                                            name="btn" class="btn btn-success waves-effect w-md waves-light m-b-5"
                                            style="!important;margin-right: 130px">ویرایش پست 
                                    </button>
                                </div>
                            ...
                            <select name="form[cat_id]" class="form-control">
                                ...
                                if ($cat) {
                                    foreach ($cat as $value) {
                                        ...
                                        <option <?php if ($information['cat_id']==$value['id']){
                                            echo ' selected';
                    ...
                    <div class="col-sm-4">
                        <div class="card-box in">
                            ...
                            <select name="form[status]" class="form-control">
                                <option value="1" <?php if ($information['status']==1){
                                    echo ' selected';
                                } ?>>منتشر می شود</option>
                                <option <?php if ($information['status']==0){
                                    echo ' selected';
                                } ?> value="0"> به عنوان پیش نویس ذخیره میشود</option>
                    ...
                    <div class="col-sm-4">
                        <div class="card-box in">
                            <h2 class="ier">آپلود تصویر پست</h2>
                            <img width="100px" src="/<?php echo $information['image']?>" alt="">
                          <br> <br> <input value=false name="file" type="file" class="form-control">
                        </div>
                    </div>
                    </form>
                </div>
                ...
                <li class="list-group-item">
                    <a src="/admin//admin/#" class="user-list-item">
                        ...
                        <div class="user-desc">
                            ...
                            <span class="desc">کاربر در سایت ثبت نام کرده است</span>
                ...
                <li class="list-group-item">
                    <a src="/admin//admin/#" class="user-list-item">
                        ...
                        <div class="user-desc">
                            ...
                            <span class="desc">متن پیام جدید از کاری</span>
