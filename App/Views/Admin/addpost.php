...
?>
                            <form class="form-horizontal" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input type="text" name="form[title]" class="form-control" placeholder="لطفا نام پست خود را وارد نمائید">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <div class="input-group">
                                            <input name="form[url]" style="text-align: left"  id="example-input2-group1"  class="form-control" placeholder="url post">
                                            <span class="input-group-addon " style="font-size: 18px;">http://site.ir/post</span>
                                        </div>
                                    </div>
                                </div>

                                <textarea id="elm1" name="form[text]"></textarea>

                                <div class="form-group">
                                    <button type="submit" style="margin-top: 20px;margin: 20px 410px 0px 0px;font-size:23px "  name="btn" class="btn btn-success waves-effect w-md waves-light m-b-5" style="!important;margin-right: 130px">افزودن پست ی جدید</button>
                                </div>
                    ...
                    <div class="col-sm-4">
                        <div class="card-box in">
                            ...
                            <select name="form[cat_id]" class="form-control">                                        <option value="0">هیچی</option>
