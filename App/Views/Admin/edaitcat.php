...
<div class="card-box">
    ...
    <form class="form-horizontal" role="form" method="post">
        <div class="form-group">
            ...
            <div class="col-md-10">
                <input value="<?php echo $value['title']?>" name="from[title]" type="text" class="form-control" placeholder="لطفا نام دسته بندی را وارد نمائید">
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-md-10">
                <div class="input-group">
                    <input value="<?php echo $value['url']?>" style="text-align: left" id="example-input2-group1" name="from[url]" class="form-control" placeholder="آدرس">
