...
<div id="wrapper">
    ...
    <!-- ========== Left Sidebar Start ========== -->
    <?php \Core\view::rander('admin/layout/menu', [
            'title'=>'ویرایش منو',
    ]) ?> <!-- Left Sidebar End -->
                        ...
                        <div class="card-box">
                            ...
                            <form class="form-horizontal" method="post" role="form">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <input value="<?php echo $show['title']?>" required type="text" id="name" name="form[title]" class="form-control"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        <div class="input-group">
                                            <input value="<?php echo $show['url']?>" required id="url" style="text-align: left" id="example-input2-group1"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <input value="<?php echo $value['sort']?>" required name="form[sort]" type="text" class="form-control"
                                ...
                                <div class="form-group">
                                    <button name="btn" class="btn btn-success waves-effect w-md waves-light m-b-5"
                                            style="font-size:18px;margin-right: 130px">ویرایش منو
                                    </button>
                                </div>
